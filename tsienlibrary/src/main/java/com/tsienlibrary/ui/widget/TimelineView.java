...
import com.tsienlibrary.utils.ConvertUtils;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, ConvertUtils.dpToPx(20, getContext()));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, ConvertUtils.dpToPx(2, getContext()));
        ...
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, ConvertUtils.dpToPx(8f, getContext()));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, ConvertUtils.dpToPx(4f, getContext()));
        typedArray.recycle();
