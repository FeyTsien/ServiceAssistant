...
public class DateUtils {
    ...
    public static void showDateAndTimePickerDialog(final Activity activity, final int themeResId, final TextView tv, final Calendar calendar) {
        // Calendar 需要这样来得到
        ...
        new TimePickerDialog(activity, themeResId,
                ...
                new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        tv.setText(tv.getText().toString() + hourOfDay + ":" + minute);
                    }
                }
                // 设置初始时间
